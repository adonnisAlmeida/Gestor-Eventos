...
class UCLVWebsiteEventController(WebsiteEventController):
    ...
    def events(self, page=1, **searches):
        ...
        event_types = Event.read_group(domain, ["id", "event_type_id"], groupby="event_type_id", orderby="event_type_id")
        event_types.insert(0, {
            'event_type_id_count': sum([int(event_type['event_type_id_count']) for event_type in event_types]),
